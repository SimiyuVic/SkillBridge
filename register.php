...
<div class="container my-5 text-center">
    <div class="row justify-content-center">
        <h3 class="text-center fw-bold my-5">Sign Up</h3>
        <div class="col-md-5 mb-3">
            <div class="card shadow">
                ...
                <a href="user-register.php">
                    <button class="btn btn-outline-primary btn-lg my-2">Sign Up</button>
                </a>
            </div>
        </div>
        <div class="col-md-5">
            <div class="card shadow">
                ...
                <a href="employer-register.php">
                    <button class="btn btn-outline-warning btn-lg my-2">Sign Up</button>
                </a>
            </div>
        </div>
    </div>
