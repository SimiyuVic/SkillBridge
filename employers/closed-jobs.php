        ...
        <div class="row">
            ...
            <div class="col-md-9">
                ...
                <div class="alert alert-warning" role="alert">
                    Jobs will only be visible here after duration has expired or you close them by choice 
                </div>
                <!-------Dashboard Info ------>
                    ...
                    <div class="card-body">
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                $sql = "SELECT jobpost_id, company_id, job_title, status FROM job_post WHERE company_id = ? AND status = 1";
