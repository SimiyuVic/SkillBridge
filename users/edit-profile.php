                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-floating mb-3">
                                            <input type="tel" name="phone_number" class="form-control" placeholder="Phone Number" value="<?php echo $row['phone_number']; ?>">
                                    ...
                                    <div class="col-md-6">
                                    <div class="form-floating mb-3">
                                            <input type="text" name="study" class="form-control" placeholder="Study" value="<?php echo $row['study']; ?>">
                                            <label for="floatingInput">Level of Study</label>
                                        </div>
                                        <div class="form-floating mb-3">
                                            <textarea class="form-control" name="description" placeholder="Leave a comment here" id="floatingTextarea" style="height: 130px;"><?php echo $row['description']; ?></textarea>
                                            <label for="floatingTextarea">Describe Yourself . . . </label>
                                        </div>
                                        <div class="form-floating mb-3">
                                            <textarea class="form-control" name="skills" placeholder="Leave a comment here" id="floatingTextarea" style="height: 130px;"><?php echo $row['skills']; ?></textarea>
