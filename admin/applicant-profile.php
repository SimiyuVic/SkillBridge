...
{
    global $connection;
    $stmt = $connection->prepare("UPDATE users SET status = ? WHERE user_id = ?");
...
if (isset($_POST['activate'])) {
    ...
    updateUserStatus($user_id, 1); // Activate user
...
if (isset($_POST['deactivate'])) {
    $user_id = $_POST['user_id'];
    updateUserStatus($user_id, 0); // Deactivate user
    header("Location: users.php");
...
<head>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0/css/all.min.css"
          integrity="sha512-mQ93GR66o7D/EVEqUp0BqL45PQa24a6LZQ2Hb4cZ2z0x0vfFSzBvKv0ATs2DSh9efIt2uc5bBO1RoQ1HhehD5g=="
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-4">
                                            ...
                                            <img src="../uploads/portfolio/<?php echo $row['project_image']; ?>"
